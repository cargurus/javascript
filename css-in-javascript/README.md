# cargurus CSS-in-JavaScript Style Guide
...
## Themes
  ...
  - Use an abstraction layer such as [react-with-styles](https://github.com/cargurus/react-with-styles) that enables theming. *react-with-styles gives us things like `withStyles()`, `ThemedStyleSheet`, and `css()` which are used in some of the examples in this document.*
